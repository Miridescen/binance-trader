...
# 注：ROE 硬止损已于 2026-05-21 移除
# 原因：5-21 03:02 BSBUSDT 触发 ROE-200% 止损，币安平仓成功但因 open_log 中
#       entry_price=NULL 导致 FIFO 匹配不到记录、回写失败，账户与本地脱节。
#       回测显示 ROE 止损对长期收益并无显著正贡献，移除以简化数据链路。
